    ...
    <AnimatedMain className="about-page">
      ...
      <div className="about-container">
        ...
        <p>
          ...
          <span className="emojicon">:D</span> I am an extrovert, I like making
          friends and taking to other people, I also like to code for fun! I am
          currently Facinated with world economics and the concept of value and
          money, I also like watching anime. Weird combination of tastes I know.
          but it's good to be unique <span className="emojicon">:3</span>
        </p>
        <div className="br" />
        <p></p>
        <div className="br" />
